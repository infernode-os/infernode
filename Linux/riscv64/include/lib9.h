/*
 * lib9.h for RISC-V 64 (RV64GC) Linux
...
/*
 * math module dtoa - riscv64 is little endian
...
/*
 * riscv64 (LP64) has 64-bit long, so we need USE_FPdbleword
