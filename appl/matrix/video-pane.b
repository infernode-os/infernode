...
# (no "pos=" — e.g. manto's /mnt/vision/feeds/<id>, which serves the
...
# the strip shows LIVE.  This is the TAK/UAS path: manto ingests the
# gimbal RTP and re-serves annotated I420 over 9P; this pane mounts it
# from anywhere on the mesh (see docs/H264-9P-BRIDGE.md §TAK).
#
...
ensureopen(): int
{
	...
	# a live source (manto /mnt/vision) has a status without it, or
