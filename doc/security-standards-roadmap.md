...
| **IA** Identification & Auth | MFA, PKI, AAL3 | Factotum + FIDO2/PIV (2FA shipped) | enrollment records, factotum protos | partial |
...
1. **AAL3-harden the YubiKey login** (UV-required, key-derived vault, DK-only keyring
   save-back, dual-key + recovery default) — see `doc/second-factor-auth.md`. *First.*
