 ...
 * (2fa) device. Portable across hosts (macOS, Linux): includes ONLY libfido2
 * + libc headers — no Inferno headers — so it links into any emu whose mkfile
 * defines -DHAVE_FIDO2 and links -lfido2 (see each platform's mkfile).
 *
