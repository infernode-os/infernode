...
extern	void		tkaacover(Image*, Rectangle, Image*, uchar*);
extern	void		tkaacovellipse(uchar*, int, int, int, int, int, int, int);
extern	void		tkaacovseg(uchar*, int, int, int, int, int, int, int);
