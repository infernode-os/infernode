/*
 * IMPORTED from upstream Inferno (inferno-os/inferno-os), os/ip/icmp6.c.
...
struct IPICMP {
	/* Ip6hdr, flattened -- Plan 9 anonymous struct member;
	...
	/* ICMPpkt, flattened -- Plan 9 anonymous struct member;
	 * clang has no -fplan9-extensions, and flattening keeps every
	 * existing field reference working unchanged. */
	uchar	type;
	uchar	code;
...
struct NdiscC
{
	/* IPICMP, flattened -- Plan 9 anonymous struct member;
	 * clang has no -fplan9-extensions, and flattening keeps every
	 * existing field reference working unchanged. */
	/* Ip6hdr, flattened (Plan 9 anonymous struct member) */
	uchar vcf[4];       	// version:4, traffic class:8, flow label:20
...
struct Ndpkt
{
	/* NdiscC, flattened -- Plan 9 anonymous struct member;
	 * clang has no -fplan9-extensions, and flattening keeps every
	 * existing field reference working unchanged. */
	/* IPICMP, flattened (Plan 9 anonymous struct member) */
	/* Ip6hdr, flattened -- Plan 9 anonymous struct member;
