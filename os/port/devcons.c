/*
 * Imported from upstream Inferno os/port/devcons.c.
 *
 * DIVERGENCE FROM UPSTREAM: the embedded RWlock in kprintq and QLock in
 * kbd are named, along with Chan's Lock. See os/bcm2837/README.md.
 */
