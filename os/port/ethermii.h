/*
 * MII: the management interface between an Ethernet MAC and its PHY.
 *
 * 9front's sys/src/9/port/ethermii.h (MIT: Copyright © 2021 Plan 9
 * Foundation, Copyright © 9front authors), unchanged but for the
 * QLock, which Plan 9 C embeds anonymously and this tree names.
 */
...
struct Mii {
	QLock	lk;		/* named: this tree's compilers have no anonymous members */
