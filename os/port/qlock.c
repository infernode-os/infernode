/*
 * Imported from upstream Inferno os/port/qlock.c.
 *
 * DIVERGENCE FROM UPSTREAM: RWlock's embedded Lock is named, so the
 * container-passes lock(l) become lock(&l->l). See
