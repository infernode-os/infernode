/*
 * Compile-time checks on the riscv64 type foundation (see ../arm64/typecheck.c).
 *
...
/* jmp_buf must hold the psABI callee-saved state and keep sp alignment */
_Static_assert(sizeof(jmp_buf) >= 26*8, "jmp_buf too small for RISC-V");
