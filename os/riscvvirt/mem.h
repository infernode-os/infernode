/*
 * Memory layout and sizes for QEMU's RISC-V `virt' machine.
 *
 * RAM starts at 0x80000000. OpenSBI occupies the first 2MB of it and
...
#define	MAXMACH		4			/* harts the kernel will run */
