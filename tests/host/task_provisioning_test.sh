...
{ /dis/tests/task_concurrent_probe.dis ConcurrentA > /tmp/task-a; echo done > /tmp/task-a.done } &
{ /dis/tests/task_concurrent_probe.dis ConcurrentB > /tmp/task-b; echo done > /tmp/task-b.done } &
{ /dis/tests/task_concurrent_probe.dis ConcurrentC > /tmp/task-c; echo done > /tmp/task-c.done } &
createsdone=no
