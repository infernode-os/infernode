...
#  e.g.  camstream-fleet.sh iris_with_gimbal 5610   (vehicle 1)
#        camstream-fleet.sh iris_b           5620   (vehicle 2)
#        camstream-fleet.sh iris_c           5630   (vehicle 3)
set -u
export GZ_VERSION=harmonic
M="${1:?model name}"; PORT="${2:?dest port}"
B="/world/iris_runway_targets/model/$M/model/gimbal/link/pitch_link/sensor/camera/image"
